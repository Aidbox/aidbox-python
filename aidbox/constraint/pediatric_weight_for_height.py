...
from ..base import *
class Coding776062(Coding):
	system: Literal["http://loinc.org"] = "http://loinc.org"
	code: Literal["77606-2"] = "77606-2"

class PediatricWeightForHeightCode(CodeableConcept):
	coding: List[Coding776062] = [Coding776062()]
...
class PediatricWeightForHeight(DomainResource):
	meta: Meta = Meta(profile=["http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height"])
	...
	status: str
	code: PediatricWeightForHeightCode = PediatricWeightForHeightCode()
