...
from ..base import *
class Coding88674(Coding):
	system: Literal["http://loinc.org"] = "http://loinc.org"
	code: Literal["8867-4"] = "8867-4"

class UsCoreHeartRateCode(CodeableConcept):
	coding: List[Coding88674] = [Coding88674()]
...
class UsCoreHeartRate(DomainResource):
	meta: Meta = Meta(profile=["http://hl7.org/fhir/us/core/StructureDefinition/us-core-heart-rate"])
	...
	status: str
	code: UsCoreHeartRateCode = UsCoreHeartRateCode()
