...
from ..base import *
class Coding294637(Coding):
	system: Literal["http://loinc.org"] = "http://loinc.org"
	code: Literal["29463-7"] = "29463-7"

class UsCoreBodyWeightCode(CodeableConcept):
	coding: List[Coding294637] = [Coding294637()]
...
class UsCoreBodyWeight(DomainResource):
	meta: Meta = Meta(profile=["http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-weight"])
	...
	status: str
	code: UsCoreBodyWeightCode = UsCoreBodyWeightCode()
