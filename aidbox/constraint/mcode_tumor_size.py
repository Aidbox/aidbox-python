...
from ..base import *
class Coding218891(Coding):
	system: Literal["http://loinc.org"] = "http://loinc.org"
	code: Literal["21889-1"] = "21889-1"

class McodeTumorSizeCode(CodeableConcept):
	coding: List[Coding218891] = [Coding218891()]
...
class McodeTumorSize(DomainResource):
	meta: Meta = Meta(profile=["http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tumor-size"])
	...
	status: str
	code: McodeTumorSizeCode = McodeTumorSizeCode()
