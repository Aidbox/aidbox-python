...
from ..base import *
class Coding83022(Coding):
	system: Literal["http://loinc.org"] = "http://loinc.org"
	code: Literal["8302-2"] = "8302-2"

class UsCoreBodyHeightCode(CodeableConcept):
	coding: List[Coding83022] = [Coding83022()]
...
class UsCoreBodyHeight(DomainResource):
	meta: Meta = Meta(profile=["http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-height"])
	...
	status: str
	code: UsCoreBodyHeightCode = UsCoreBodyHeightCode()
