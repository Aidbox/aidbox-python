...
from ..base import *
class Coding82891(Coding):
	system: Literal["http://loinc.org"] = "http://loinc.org"
	code: Literal["8289-1"] = "8289-1"

class HeadOccipitalFrontalCircumferencePercentileCode(CodeableConcept):
	coding: List[Coding82891] = [Coding82891()]
...
class HeadOccipitalFrontalCircumferencePercentile(DomainResource):
	meta: Meta = Meta(profile=["http://hl7.org/fhir/us/core/StructureDefinition/head-occipital-frontal-circumference-percentile"])
	...
	status: str
	code: HeadOccipitalFrontalCircumferencePercentileCode = HeadOccipitalFrontalCircumferencePercentileCode()
