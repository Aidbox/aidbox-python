...
from ..base import *
class Coding92791(Coding):
	system: Literal["http://loinc.org"] = "http://loinc.org"
	code: Literal["9279-1"] = "9279-1"

class UsCoreRespiratoryRateCode(CodeableConcept):
	coding: List[Coding92791] = [Coding92791()]
...
class UsCoreRespiratoryRate(DomainResource):
	meta: Meta = Meta(profile=["http://hl7.org/fhir/us/core/StructureDefinition/us-core-respiratory-rate"])
	...
	status: str
	code: UsCoreRespiratoryRateCode = UsCoreRespiratoryRateCode()
