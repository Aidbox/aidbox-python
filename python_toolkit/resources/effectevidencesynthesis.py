...
class EffectEvidenceSynthesis_EffectEstimate(BackboneElement):
	...
	precisionEstimate: list[EffectEvidenceSynthesis_EffectEstimate_PrecisionEstimate] = []
	type: Optional[CodeableConcept] = None
...
class EffectEvidenceSynthesis_Certainty(BackboneElement):
	certaintySubcomponent: list[EffectEvidenceSynthesis_Certainty_CertaintySubcomponent] = []
	note: list[Annotation] = []
	rating: list[CodeableConcept] = []
